...
export default function Skills() {
  const renderSkillItem = (skill) => (
    <div key={skill.name} className="skill-item relative">
      <div className="mb-1.5 flex justify-between font-mono text-[9px] font-black uppercase tracking-[0.2em] text-white max-md:mb-1.5 max-md:text-[8.5px] max-md:tracking-[0.16em] sm:text-[10px] md:mb-2 md:text-xs">
        ...
        <span className="skill-number text-[color:var(--theme-accent)]">{skill.level}%</span>
      </div>
 ...
 <div className="relative rounded-[1.5rem] border border-[color:var(--theme-border)] [background:var(--theme-panel-bg)] p-4 [box-shadow:var(--theme-panel-shadow)] backdrop-blur-md max-md:rounded-[1.2rem] max-md:p-4 sm:rounded-[2rem] md:p-7 lg:p-8">
 ...
 <div className="relative block rounded-[1.5rem] border border-[color:var(--theme-border)] [background:var(--theme-panel-bg-strong)] p-4 [box-shadow:var(--theme-panel-shadow)] backdrop-blur-md max-md:rounded-[1.2rem] max-md:p-4 sm:rounded-[2rem] md:p-7 lg:p-8">
